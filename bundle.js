...
function main(_ref) {
  ...
  var mousePosition$ = MousePosition.positions();

  return {
    DOM: mousePosition$.map(function (pos) {
      return (0, _dom.div)('.container', [(0, _dom.h1)('Where\'s my 🐭 at?'), (0, _dom.h3)('X: ' + pos.x + ', Y: ' + pos.y)]);
    })
  };
}

},{"@cycle/dom":4,"rx":25}],2:[function(require,module,exports){
'use strict';
...
var _mousePositionDriver = require('../../src/mouse-position-driver');
...
var drivers = {
  ...
  MousePosition: (0, _mousePositionDriver.makeMousePositionDriver)()
};

(0, _core.run)(app, drivers);

},{"../../src/mouse-position-driver":64,"./app":1,"@cycle/core":3,"@cycle/dom":4,"rx":25}],3:[function(require,module,exports){
"use strict";
...
exports.makeMousePositionDriver = makeMousePositionDriver;

var _rx = require('rx');

function makeMousePositionDriver() {
  return function mousePositionDriver() {
    return {
      positions: function positions() {
        return _rx.Observable.fromEvent(document, 'mousemove').map(function (ev) {

...
function main(_ref) {
  ...
  var mousePosition$ = Mouse.positions();
  var click$ = Mouse.click();

  var clickCount$ = click$.fold(function (acc, ev) {
    return acc + 1;
  }, 0);

  var state$ = _xstream2.default.combine(mousePosition$, clickCount$);
  ...
  return {
    DOM: state$.map(function (_ref2) {
      ...
      var pos = _ref3[0];
      var clickCount = _ref3[1];
      return (0, _dom.div)('.container', [(0, _dom.h1)('Where\'s my 🐭 at?'), (0, _dom.h3)('X: ' + pos.x + ', Y: ' + pos.y), (0, _dom.p)('p.s. you\'ve clicked ' + clickCount + ' times')]);
    })
  };
}

},{"@cycle/dom":13,"xstream":121}],2:[function(require,module,exports){
'use strict';
...
var _mouseDriver = require('../../src/mouse-driver');

var app = require('./app').default;

var drivers = {
  DOM: (0, _dom.makeDOMDriver)('.app'),
  Mouse: (0, _mouseDriver.makeMouseDriver)()
};

(0, _xstreamRun.run)(app, drivers);

},{"../../src/mouse-driver":122,"./app":1,"@cycle/dom":13,"@cycle/xstream-run":23}],3:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":8,"./utils":21,"matches-selector":97}],5:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":8,"./utils":21,"matches-selector":97}],6:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":22,"xstream":121}],7:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":4,"./EventDelegator":5,"./fromEvent":10,"./isolate":14,"./utils":21,"@cycle/xstream-adapter":22,"matches-selector":97,"xstream":121}],8:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":12,"snabbdom-selector/lib/classNameFromVNode":98,"snabbdom-selector/lib/selectorParser":99}],10:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"xstream":121}],11:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"snabbdom/is":109,"snabbdom/vnode":118}],13:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":12,"./hyperscript-helpers":11,"./makeDOMDriver":16,"./makeHTMLDriver":17,"./mockDOMSource":18,"snabbdom/thunk":117}],14:[function(require,module,exports){
"use strict";
var utils_1 = require('./utils');
...
},{"./MainDOMSource":7,"./VNodeWrapper":9,"./isolateModule":15,"./modules":19,"./transposition":20,"./utils":21,"@cycle/xstream-adapter":22,"es6-map":66,"snabbdom":116,"xstream":121}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":6,"./transposition":20,"@cycle/xstream-adapter":22,"snabbdom-to-html":101}],18:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":22,"xstream":121}],19:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":110,"snabbdom/modules/class":111,"snabbdom/modules/eventlisteners":112,"snabbdom/modules/hero":113,"snabbdom/modules/props":114,"snabbdom/modules/style":115}],20:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":22,"xstream":121}],21:[function(require,module,exports){
"use strict";
...
},{"xstream":121}],23:[function(require,module,exports){
"use strict";
...
},{"./selectorParser":99}],99:[function(require,module,exports){
'use strict';
...
},{"browser-split":24}],100:[function(require,module,exports){
...
},{"./init":102,"./modules/attributes":103,"./modules/style":104}],102:[function(require,module,exports){
...
},{"./container-elements":100,"./parse-selector":105,"./void-elements":106}],103:[function(require,module,exports){
...
},{"../parse-selector":105,"lodash.escape":88,"lodash.forown":89,"lodash.union":95}],104:[function(require,module,exports){
...
},{"lodash.escape":88,"lodash.forown":89,"lodash.kebabcase":92}],105:[function(require,module,exports){
...
},{"../is":109}],113:[function(require,module,exports){
...
},{"./htmldomapi":108,"./is":109,"./vnode":118}],117:[function(require,module,exports){
var h = require('./h');
...
},{"./h":107}],118:[function(require,module,exports){
...
exports.makeMouseDriver = makeMouseDriver;
...
function makeMouseDriver() {
  return function mouseDriver(sinks, streamAdapter) {
    return {
      positions: function positions() {
        var positions$ = (0, _fromEvent2.default)(document, 'mousemove').map(function (ev) {
          return { x: ev.clientX, y: ev.clientY };
        }).startWith({ x: 0, y: 0 });

        return streamAdapter.adapt(positions$, _xstreamAdapter2.default.streamSubscribe);
      },
      up: function up() {
        var up$ = (0, _fromEvent2.default)(document, 'mouseup');

        return streamAdapter.adapt(up$, _xstreamAdapter2.default.streamSubscribe);
      },
      down: function down() {
        var down$ = (0, _fromEvent2.default)(document, 'mousedown');

        return streamAdapter.adapt(down$, _xstreamAdapter2.default.streamSubscribe);
      },
      click: function click() {
        var click$ = (0, _fromEvent2.default)(document, 'click');

        return streamAdapter.adapt(click$, _xstreamAdapter2.default.streamSubscribe);
      }
    };
  };
}

},{"@cycle/xstream-adapter":22,"xstream/extra/fromEvent":120}]},{},[2]);
